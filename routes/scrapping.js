...
const fn_scrapping = {
    ...
    extractingData: function (ele) {
        ...
        // template.posterUrl = ele.querySelector('.content-thumbnail a img').rawAttributes.src;
    ...
    searchQuery: async function (query) {
        ...
        let url = `https://111.90.159.159/?s=${query.replaceAll(/\s/g, '+')}&post_type%5B%5D=post`;
